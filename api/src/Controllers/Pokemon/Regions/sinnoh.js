...
let getPokemonsOfSinnoh = async () => {
	let sinnoh = await axios.get(
		'https://pokeapi.co/api/v2/pokemon/?offset=386&limit=107',
	);

	let allPokemonOfSinnoh = sinnoh.data.results;

	for (let pokemon of allPokemonOfSinnoh) {
...
module.exports = getPokemonsOfSinnoh;
