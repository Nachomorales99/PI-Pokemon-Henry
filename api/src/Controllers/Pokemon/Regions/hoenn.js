...
let getPokemonsOfHoenn = async () => {
	let hoenn = await axios.get(
		'https://pokeapi.co/api/v2/pokemon/?offset=251&limit=135',
	);

	let allPokemonOfHoenn = hoenn.data.results;

	for (let pokemon of allPokemonOfHoenn) {
...
module.exports = getPokemonsOfHoenn;
